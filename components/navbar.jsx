    ...
    return (
        <>
            <nav className='sticky top-0 z-50 flex w-full items-center justify-between bg-white/50 px-4 py-3.5 backdrop-blur-md md:px-16 lg:px-24'>
                ...
                <a href="https://analyzervisualizertool1-6appycnvd8narah7hbdr78g.streamlit.app/" target="_blank" rel="noopener noreferrer" className='hidden rounded-full btn px-8 py-2.5 font-medium text-white transition hover:opacity-90 md:inline-block'>
                    Launch App
                </a>
            ...
            <div className={`fixed inset-0 z-50 flex flex-col items-center justify-center gap-6 bg-white/20 text-lg font-medium backdrop-blur-2xl transition duration-300 md:hidden ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                <a href="https://analyzervisualizertool1-6appycnvd8narah7hbdr78g.streamlit.app/" target="_blank" rel="noopener noreferrer" className='rounded-full btn px-8 py-2.5 font-medium text-white transition hover:opacity-90' onClick={() => setIsOpen(false)}>
                    Launch App
                </a>
